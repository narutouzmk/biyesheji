...
<head>
    ...
    <link href="static/css/capital.css" rel="stylesheet"/>
</head>
<body>
<div class="container">
    <!--<div class="col-md-6">-->
    <div class="container-fluid my-container-1">
        <ul class="nav nav-pills">
            ...
            <li class="dropdown" role="presentation">
                ...
                <ul class="dropdown-menu">
                    <li><a href="#">个人资产总概括</a></li>
                    <li class="divider"></li>
                    <li><a href="/capital_sellOut">资产卖出出情况</a></li>
                    <li class="divider"></li>
...
<div class="container-fluid my-container-2">
    ...
    <div class="col-md-7 my-col-md-7-right">
        <h3>总资产消费情况</h3>
        <p class="small_title">当前页面列出了当前资产总览</p>
        <div class="container-fluid my-container-3">
            <h4>总资产各个方面分布状态</h4>
            <div class="progress my-progress">
                <div class="progress-bar progress-bar-success" style="width: ${requestScope.p_in}%">
                    <span class="sr-only">${requestScope.p_in}\%</span>
                </div>
                <div class="progress-bar progress-bar-warning progress-bar-striped" style="width: ${requestScope.p_out}%">
                    <span class="sr-only">${requestScope.p_out}\%</span>
                </div>
                <div class="progress-bar progress-bar-danger" style="width: ${requestScope.p_n}%">
                    <span class="sr-only">${requestScope.p_n}\%</span>
                </div>
            </div>

            <div class="divider"></div>
            <div class="container-fluid my-container-4">
                <table class="table table-hover table-responsive">
                    ...
                    <tbody>
                    <tr>
                        <td>${requestScope.capital_in}</td>
                        <td>${requestScope.capital_out}</td>
                        <td>${requestScope.negative_consume}</td>
                        <td>${requestScope.capital_mm}</td>
                    </tr>
                    </tbody>
                </table>
            </div>
