...
<div class="container-fluid my-container-2">
    ...
    <div class="col-md-7 my-col-md-7-right">
        <h3>日记本</h3><p class="small_title">记录每天点点滴滴</p>
        <div class="container-fluid my-mark">
            ${requestScope.info_message1}
            <table class="table table-hover table-responsive">
                <thead></thead>
                <tbody>
                    <c:forEach items="${requestScope.dayNotes}" var="dayNote">
                        <tr>
        ...
        <div class="container-fluid">
            <form class="form-inline" id="my_form" action="/user_3DateCheck">
                <div class="form-group">
                    <label>请输入日期查询日记</label>
                    <input type="date" class="form-control" id="my_date" name="note_date"/>
