...
<div class="container-fluid my-container-2">
    ...
    <div class="col-md-7 my-col-md-7-right">
        <h3>今日小账本</h3><p class="small_title">请在对应分类区输入您今天的资产买入情况</p>

        <div class="container-fluid my-container-3">
            <form class="form-horizontal" id="form_note" action="/insert_capitalIn">
                <table class="table table-bordered">
                    <caption>资产买入细则</caption>
                    <thead>
                    <th>买入项目</th>
                    <th>花费金额</th>
                    </thead>
                    ...
                    <tr>
                        <td>
                            <input id="input_item" class="form-control" name="capitali_item"/>
                        </td>
                        <td>
                            <input id="input_count" class="form-control" name="capitali_count"/>
                        </td>
                    </tr>
                    </tbody>
                </table>
