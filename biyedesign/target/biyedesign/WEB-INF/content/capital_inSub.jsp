...
<div class="container-fluid my-container-2">
    ...
    <div class="col-md-7 my-col-md-7-right">
        <h3>基础账单</h3><p class="small_title">本月的基本收入情况</p>

        <div class="container-fluid">
            ${requestScope.mess_capitalIn1}
            <table class="table table-hover table-responsive">
                ...
                <tbody>
                <c:forEach items="${requestScope.capitalInList}" var="oneCapitalIn">
                    <tr>
                        <td>${oneCapitalIn.capitali_id}</td>
                        <td>${oneCapitalIn.capitali_item}</td>
                        <td>${oneCapitalIn.capitali_count}</td>
                        <td>${oneCapitalIn.capitali_date}</td>
                    </tr>
                </c:forEach>
                </tbody>
            </table>
        ...
        <div class="col-md-7 my-col-md-7-right my-generalize-table2">
            <form class="form-inline" action="/capital_in_delete">
                <div class="form-group">
                    <label>请输入您所需要删除的资本买入记录的编号</label>
                    <input type="number" class="form-control" id="delete_capital_i_item" name="capitali_id"/>
        ...
        <div class="col-md-7 my-col-md-7-right my-generalize-table2">
            <form class="form-horizontal" action="/capital_in_update">
                <label>请输入您所需要修改的资本买入记录编号</label>
                <div class="form-group">
                    <input type="number" class="form-control " id="capital_update_id_in" name="capitali_id" placeholder="请输入编号"/>
                </div>
                <div class="form-group">
                    <input type="text" class="form-control" id="capital_update_item_in" name="capitali_item" placeholder="请输入卖出项目修改后的内容"/>
                </div>
                <div class="form-group">
                    <input type="number" class="form-control" id="capital_update_count_in" name="capitali_count" placeholder="请输入所得金额修改值"/>
                </div>
                <div class="form-group">
                    <input type="date" class="form-control" id="capital_update_date_in" name="capitali_date" placeholder="请输入卖出资本日期修改值"/>
                </div>
