...
<div class="container-fluid my-container-2">
    ...
    <div class="col-md-7 my-col-md-7-right">
        ...
        <div class="container-fluid">
            ${requestScope.mess_revenueItem2}
            <table class="table table-hover table-responsive">
                ...
                <tbody>
                <c:forEach items="${requestScope.dayRevenueItemList}" var="oneDayRevenueItem">
                    <tr>
                        <td>${oneDayRevenueItem.earn_id}</td>
                        <td>${oneDayRevenueItem.earn_item}</td>
                        <td>${oneDayRevenueItem.earn_count}</td>
                        <td>${oneDayRevenueItem.earn_date}</td>
                    </tr>
                </c:forEach>
                </tbody>
            </table>
        ...
        <div class="col-md-7 my-col-md-7-right my-generalize-table2">
            <form class="form-inline" action="/user_7Delete">
                <div class="form-group">
                    <label>请输入您所需要删除的收入记录的编号</label>
                    <input type="number" class="form-control" id="delete_Ritem" name="earn_id"/>
        ...
        <div class="col-md-7 my-col-md-7-right my-generalize-table2">
            <form class="form-horizontal" action="/user_7Update">
                <label>请输入您所需要修改的收入记录编号</label>
                <div class="form-group">
                    <input type="number" class="form-control " id="update_Rid" name="earn_id" placeholder="请输入编号"/>
                </div>
                <div class="form-group">
                    <input type="text" class="form-control" id="update_Ritem" name="earn_item" placeholder="请输入收入记录修改后的内容"/>
                </div>
                <div class="form-group">
                    <input type="number" class="form-control" id="update_Rcount" name="earn_count" placeholder="请输入收入金额修改值"/>
                </div>
                <div class="form-group">
                    <input type="date" class="form-control" id="update_Rdate" name="earn_date" placeholder="请输入收入日期修改值"/>
                </div>
