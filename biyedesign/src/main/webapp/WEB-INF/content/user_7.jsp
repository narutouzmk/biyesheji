    ...
    <div class="col-md-7 my-col-md-7-right">
        ...
        <div class="container-fluid">
            ...
            <table class="table table-hover table-responsive">
                ...
                <tbody>
                <c:forEach items="${requestScope.dayRevenueItems}" var="dayRevenueItem">
                    <tr>
                        <td>${dayRevenueItem.earn_id}</td>
                        <td>${dayRevenueItem.earn_item}</td>
                        <td>${dayRevenueItem.earn_count}</td>
                        <td>${dayRevenueItem.earn_date}</td>
                    </tr>
                </c:forEach>
                </tbody>
            </table>
        ...
        <div class="container-fluid">
            <form class="form-inline" id="my_form" action="/user_7DateCheck">
                <div class="form-group">
                    <label>请输入日期查询日记</label>
                    <input type="date" class="form-control" id="my_date" name="earn_date"/>
