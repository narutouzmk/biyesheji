...
<div class="container-fluid my-manager-container-0">
    ...
    <div class="col-md-8 my-side-right">
        ...
        ${requestScope.mess_data_produce}
        <div class="container-fluid my-produce">
            <table class="table table-bordered">
                ...
                <tbody>
                <c:forEach items="${requestScope.produceList_date}" var="today_produce">
                    <tr>
                        <td>${today_produce.produce_id}</td>
                        <td>${today_produce.produce_item}</td>
                        <td>${today_produce.produce_company}</td>
                        <td>${today_produce.online_date}</td>
                        <td>${today_produce.produce_state}</td>
                        <td>${today_produce.produce_suit}</td>
                    </tr>
                </c:forEach>
                </tbody>
            </table>
