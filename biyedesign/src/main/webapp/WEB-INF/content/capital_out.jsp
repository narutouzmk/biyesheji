...
<div class="container-fluid my-container-2">
    ...
    <div class="col-md-7 my-col-md-7-right">
        <h3>资本卖出</h3><p class="small_title">本月的资本卖出情况</p>

        <div class="container-fluid">
            ${requestScope.mess_capitalOut}
            <table class="table table-hover table-responsive">
                ...
                <tbody>
                <c:forEach items="${requestScope.capitalOuts}" var="capitalOut">
                    <tr>
                        <td>${capitalOut.capitalo_id}</td>
                        <td>${capitalOut.capitalo_item}</td>
                        <td>${capitalOut.capitalo_count}</td>
                        <td>${capitalOut.capitalo_date}</td>
                    </tr>
                </c:forEach>
                </tbody>
            </table>
        ...
        <div class="container-fluid">
            <form class="form-inline" id="my_form" action="/capital_outCheckByDate">
                <div class="form-group">
                    <label>请输入日期查询日记</label>
                    <input type="date" class="form-control" id="my_date" name="capitalo_date"/>
