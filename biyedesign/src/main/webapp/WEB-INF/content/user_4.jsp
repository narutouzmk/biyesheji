...
<div class="container-fluid my-container-2">
    ...
    <div class="col-md-7 my-col-md-7-right">
        <h3>今日小账本</h3><p class="small_title">请在对应分类区输入您今天的详细消费情况</p>

        <div class="container-fluid my-container-3">
            <form class="form-horizontal" id="form_note" action="/insert_consumeItem">
                <table class="table table-bordered">
                    ...
                    <tr>
                        <td>
                            <input id="input_item" class="form-control" name="consume_item"/>
                        </td>
                        <td>
                            <input id="input_count" class="form-control" name="consume_count"/>
                        </td>
                    </tr>
                    </tbody>
                </table>
