...
<head>
    ...
    <link href="static/css/user_2.css" rel="stylesheet"/>
...
<div class="container-fluid my-container-2">
    ...
    <div class="col-md-7 my-col-md-7-right">
        <h3>今日账本(大)</h3><p class="small_title">请在对应分类区输入您今天的基本消费情况</p>

        <div class="container-fluid my-container-3">
            <form class="form-horizontal" action="/InsertGeneralizeConsume" id="form_generalize">
                <div class="form-group">
                    <label for="input_life" class="col-md-3 control-label">生活消费(如买衣服，吃饭等)</label>
                    <div class="col-md-8">
                        <input type="text" class="form-control" id="input_life" name="life_consume"/>
                    </div>
                </div>

                <div class="form-group">
                    <label for="input_lesson" class="col-md-3 control-label">学习消费(如买书，教程等)</label>
                    <div class="col-md-8">
                        <input type="text" class="form-control" id="input_lesson" name="learn_consume"/>
                    </div>
                </div>

                <div class="form-group">
                    <label for="input_entertainment" class="col-md-3 control-label">娱乐消费(如看电影，聚会等)</label>
                    <div class="col-md-8">
                        <input type="text" class="form-control" id="input_entertainment" name="entertainment_consume"/>
                    </div>
                </div>

                <div class="form-group">
                    <label for="input_invest" class="col-md-3 control-label">投资消费(如看买股票，债券等)</label>
                    <div class="col-md-8">
                        <input type="text" class="form-control" id="input_invest" name="invest_consume"/>
                    </div>
                </div>

                <div class="form-group">
                    <label for="input_other" class="col-md-3 control-label">其他消费(如罚款等)</label>
                    <div class="col-md-8">
                        <input type="text" class="form-control" id="input_other" name="other_consume"/>
                    </div>
                </div>
                <div class="form-group">
                    <div class="col-md-offset-4">
                        <button type="button" id="sub_generalize" class="col-md-5 btn btn-success" >提交</button>
                    </div>
                </div>
            </form>
        </div>
        ...
        <div class="container-fluid">
            <form class="form-horizontal" id="form_note" action="/insert_note">
                <div class="form-group">
                    <label for="input_note" class="col-sm-2 control-label">我的日记</label>
                    <div class="col-md-8">
                        <textarea class="form-control col-md-8" rows="6" id="input_note" name="note_item"></textarea>
                    </div>
                </div>
                <div class="form-group">
                    <div class="col-md-offset-4">
                        <button type="button" id="sub_note" class="col-md-5 btn btn-success" >提交</button>
                    </div>
                </div>
            </form>
        </div>
...
<script src="static/js/consume_generalize.js"></script>
</html>
