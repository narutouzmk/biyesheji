    ...
    <div class="col-md-7 my-col-md-7-right">
        ...
        <div class="container-fluid">
            ...
            <table class="table table-hover table-responsive">
                ...
                <tbody>
                <c:forEach items="${requestScope.dayConsumeItems}" var="dayConsumeItem">
                    <tr>
                        <td>${dayConsumeItem.consume_id}</td>
                        <td>${dayConsumeItem.consume_item}</td>
                        <td>${dayConsumeItem.consume_count}</td>
                        <td>${dayConsumeItem.consume_date}</td>
                    </tr>
                </c:forEach>
                </tbody>
            </table>
        ...
        <div class="container-fluid">
            <form class="form-inline" id="my_form" action="/user_6DateCheck">
                <div class="form-group">
                    <label>请输入日期查询日记</label>
                    <input type="date" class="form-control" id="my_date" name="consume_date"/>
