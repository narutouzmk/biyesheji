...
<head>
    ...
    <link href="static/css/produce.css" rel="stylesheet"/>
</head>
<body>
<div class="container">
    <!--<div class="col-md-6">-->
...
<div class="container-fluid my-container-2">
    ...
    <div class="col-md-7 my-col-md-7-right">
        <h3>为您智能推荐适合您的理财产品</h3><p class="small_title">我们罗列了当前最适合您的理财产品</p>
        <div class="container-fluid my-mark">
            <table class="table">
                ...
                <tbody>
                <c:forEach items="${requestScope.produceList}" var="suit_produce">
                    <tr>
                        <td>${suit_produce.produce_item}</td>
                        <td>${suit_produce.produce_company}</td>
                        <td><a href="${suit_produce.produce_state}">查看产品</a></td>
                        <td>${suit_produce.online_date}</td>
                    </tr>
                </c:forEach>
                </tbody>
            </table>
        </div>
        <div><a href="/look_upAllProduce">点击查看全部理财产品</a></div>
    </div>
</div>
