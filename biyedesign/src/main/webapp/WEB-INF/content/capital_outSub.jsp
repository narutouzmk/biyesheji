    ...
    <div class="col-md-7 my-col-md-7-right">
        ...
        <div class="container-fluid">
            ...
            <table class="table table-hover table-responsive">
                ...
                <tbody>
                <c:forEach items="${requestScope.capitalOutList}" var="oneCapitalOut">
                    <tr>
                        <td>${oneCapitalOut.capitalo_id}</td>
                        <td>${oneCapitalOut.capitalo_item}</td>
                        <td>${oneCapitalOut.capitalo_count}</td>
                        <td>${oneCapitalOut.capitalo_date}</td>
                    </tr>
                </c:forEach>
                </tbody>
            </table>
        ...
        <div class="col-md-7 my-col-md-7-right my-generalize-table2">
            <form class="form-inline" action="/capital_out_delete">
                <div class="form-group">
                    <label>请输入您所需要删除的资本卖出记录的编号</label>
                    <input type="number" class="form-control" id="delete_capital_o_item" name="capitalo_id"/>
        ...
        <div class="col-md-7 my-col-md-7-right my-generalize-table2">
            <form class="form-horizontal" action="/capital_out_update">
                <label>请输入您所需要修改的资本卖出记录编号</label>
                <div class="form-group">
                    <input type="number" class="form-control " id="capital_update_id_out" name="capitalo_id" placeholder="请输入编号"/>
                </div>
                <div class="form-group">
                    <input type="text" class="form-control" id="capital_update_item_out" name="capitalo_item" placeholder="请输入卖出项目修改后的内容"/>
                </div>
                <div class="form-group">
                    <input type="number" class="form-control" id="capital_update_count_out" name="capitalo_count" placeholder="请输入所得金额修改值"/>
                </div>
                <div class="form-group">
                    <input type="date" class="form-control" id="capital_update_date_out" name="capitalo_date" placeholder="请输入卖出资本日期修改值"/>
                </div>
